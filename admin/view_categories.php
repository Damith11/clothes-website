            ...
            <div class="head-title">
                  <div class="left">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li class="divider">/</li>
                        <li><a href="insert_categories.php" class="active">View Categorie</a></li>
                    </ul> 
                  </div>
            ...
            <div class="table">
                <div class="table_header">
                    ...
                    <div class="">
                        ...
                        <a href="insert_categories.php" class="add_new">
                ...
                <div class="table-section">
                    <table>
                        ...
                        <tbody>
                            <?php
                                $get_categorie="SELECT * FROM `categories`";
                                $result=mysqli_query($con,$get_categorie);
                                $number=0;
                                ...
                                ?>
                                     <tr>
                                        ...
                                        <td><img src='./category_images/<?php echo $category_img  ?>' alt=''></td>
                                        
                                        <td>
                                            <a href="update_categories.php?update_categories=<?php echo $row['category_id']; ?>" class='ta_icon'>
                                                <i class='bx bxs-edit' ></i>
                                            </a>

                                            <a href="delete_categories.php?delete_categories=<?php echo $row['category_id']; ?>" onclick="return confirm('Are you sure want to delete this product?');"class='ta_icon'>
