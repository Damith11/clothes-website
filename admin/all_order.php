                    ...
                    <table>
                        <thead>
                            ...
                            <?php 
                                ...
                                if($row_count==0){
                                    echo"<h2 class='empty_msg'>No Order Yet....</h2>";
                                }
                                        ...
                                        ?>
                                          ...
                                          <tbody>
                                            <tr>
                                                ...
                                                <td> 
                                                <a href="all_order_print.php?order_id=<?php echo $order_id; ?>" class="icon_print"><i class="fi fi-rs-file-download"></i></a>
                                                
                                                    <a href="delete_order.php?delete_order=<?php echo $order_id; ?>" onclick="return confirm('Are you sure want to delete this Order?');"class='ta_icon side_ic'>
